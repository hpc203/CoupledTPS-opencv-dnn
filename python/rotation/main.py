...
if __name__=='__main__':
    ...
    parser.add_argument("--imgpath", type=str, default='testimgs/rotation/DRC-D/00150_-8.4.jpg')
    parser.add_argument('--iter_num', type=int, default=3)
    args = parser.parse_args()

    myNet = CoupledTPS_RotationNet('weights/rotation/rotation/feature_extractor.onnx', 'weights/rotation/rotation/regressnet.onnx')
    ...
    ####cv2.imwrite('python-opencv-dnn-CoupledTPS_Rotation.jpg', combine_img)
    cv2.namedWindow('opencv-dnn-CoupledTPS_Rotation', 0)
    cv2.imshow('opencv-dnn-CoupledTPS_Rotation', combine_img)
    cv2.waitKey(0)
